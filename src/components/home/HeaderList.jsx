...
export function HeaderList({children}){
  return (
    <StyledWrapper>
      <div className="nav">
        <div className="container">
         {children}
          <svg className="outline" overflow="visible" width="100%" height="100%" viewBox="0 0 400 60" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
